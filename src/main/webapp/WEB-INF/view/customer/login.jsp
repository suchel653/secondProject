...
<link href="/css/customer/default-layout.css" type="text/css"
	rel="stylesheet" />
</head>
...
<body>
	...
	<main id="main" class="main">
		<div class="login-container">
			...
			<div class="form">
				<form id="reg" method="post" class="join-form"
					onsubmit="return submitCheck();" action="join">
					...
					<div id="confirm">
						<input type="text" class="normal" placeholder="인증번호입력"> <input
					...
					<div id="nickname">
						<input type="text" name="nickname" class="normal name"
							placeholder="NicName"> <input type="button"
							value="닉네임 중복확인">
					</div>
				...
				<div class="login-div">
					<form class="login-form" method="post" action="login">
						...
						<div id="email">
							<input type="text" name="username" class="normal"
								placeholder="Email">
						</div>
