...
public class StudyApplyView extends StudyApply {
	...
	public StudyApplyView(int id, int StudyId, String studyTitle, int memberId, String memberNickname, Date regDate,
			String comment, int resultStatus, Date resultDate, int resultChecked) {
