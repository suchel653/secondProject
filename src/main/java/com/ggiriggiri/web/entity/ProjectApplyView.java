...
public class ProjectApplyView extends ProjectApply {
	...
	public ProjectApplyView(int id, int projectId, String projectTitle, int memberId, String memberNickname,
			Date regDate, String comment, int resultStatus, Date resultDate, int resultChecked) {
